...
final class Env(
  ...
  private val settings = new {
    ...
    val CollectionUser = "user" //config getString "collection.user"
    val CollectionCache = "cache" //config getString "collection.user"
    val CollectionNote = "note" //config getString "collection.note"
    val CollectionTrophy = "trophy" //config getString "collection.trophy"
  }
  import settings._
